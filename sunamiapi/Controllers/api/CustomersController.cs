                ...
                for (int g = 0; g < i; g++)
                {
                    ...
                    try
                    {
                        ...
                        else if(msg.StartsWith("remind"))
                        {
                            ...
                            {
                                msgs = "Jambo " + firstname[0].ToUpper() + "\n" + msg + "Sunami solar inakujulisha kwamba una deni la KSH" + not_paid.ToString("C").Trim('$') + ".Tafadhali tuma malipo yako kwa Mpesa till number 784289 (Buy goods & services). Nambari ya kuhudumiwa ni 0788103403";
                                sendmsg(sim_no, msgs, se1, cust_idd);
                                // return "successfully sent";
                            }
                        }
